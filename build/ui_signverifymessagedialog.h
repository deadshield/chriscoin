...
public:
    ...
    QValidatedLineEdit *pubkeyOut_VM;
    ...
    void setupUi(QDialog *SignVerifyMessageDialog)
    {
        ...
        pubkeyOut_VM = new QValidatedLineEdit(tabSignMessage);
        pubkeyOut_VM->setObjectName(QString::fromUtf8("pubkeyOut_VM"));
        pubkeyOut_VM->setMaxLength(128);

        verticalLayout_SM->addWidget(pubkeyOut_VM);
        ...
        pubkeyIn_VM->setObjectName(QString::fromUtf8("pubkeyIn_VM"));
        pubkeyIn_VM->setMaxLength(128);
...
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_TOOLTIP
        pubkeyOut_VM->setToolTip(QApplication::translate("SignVerifyMessageDialog", "The public key used to sign the message", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        signMessageButton_SM->setToolTip(QApplication::translate("SignVerifyMessageDialog", "Sign the message to prove you own this MaxCoin address", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        pubkeyIn_VM->setToolTip(QApplication::translate("SignVerifyMessageDialog", "The public key used to sign the message", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_TOOLTIP
        verifyMessageButton_VM->setToolTip(QApplication::translate("SignVerifyMessageDialog", "Verify the message to ensure it was signed with the specified MaxCoin address", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
