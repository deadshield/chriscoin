...
public:
    ...
    void setupUi(QDialog *AboutDialog)
    {
        ...
        copyrightLabel->setText(QString::fromUtf8("Copyright &copy; 2009-2014 The Bitcoin developers, 2014 The MaxCoin developers"));
